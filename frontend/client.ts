 ...
 */
export class Client {
    public readonly pptx: pptx.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.pptx = new pptx.ServiceClient(base)
    }
 ...
 */
import { deleteGeneratedFile as api_pptx_delete_generated_file_deleteGeneratedFile } from "~backend/pptx/delete_generated_file";
import { deleteSession as api_pptx_delete_session_deleteSession } from "~backend/pptx/delete_session";
...
export namespace pptx {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.deleteGeneratedFile = this.deleteGeneratedFile.bind(this)
            ...
            this.uploadArchiveChunkRaw = this.uploadArchiveChunkRaw.bind(this)
            this.uploadArchiveRaw = this.uploadArchiveRaw.bind(this)
            this.uploadImages = this.uploadImages.bind(this)
            this.uploadTemplate = this.uploadTemplate.bind(this)
            this.uploadTemplateRaw = this.uploadTemplateRaw.bind(this)
        }

        /**
         * Deletes a generated presentation file.
         */
        public async deleteGeneratedFile(params: { fileId: number }): Promise<ResponseType<typeof api_pptx_delete_generated_file_deleteGeneratedFile>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/generated-files/${encodeURIComponent(params.fileId)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_delete_generated_file_deleteGeneratedFile>
        }

        /**
         * Deletes a session and all associated files.
         */
        public async deleteSession(params: { sessionId: string }): Promise<ResponseType<typeof api_pptx_delete_session_deleteSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions/${encodeURIComponent(params.sessionId)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_delete_session_deleteSession>
        }

        /**
         * Deletes a template and its associated file.
         */
        public async deleteTemplate(params: { templateId: number }): Promise<ResponseType<typeof api_pptx_delete_template_deleteTemplate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/templates/${encodeURIComponent(params.templateId)}`, {method: "DELETE", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_delete_template_deleteTemplate>
        }

        /**
         * Generates a PowerPoint presentation from template and session data.
         */
        public async generate(params: RequestType<typeof api_pptx_generate_generate>): Promise<ResponseType<typeof api_pptx_generate_generate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/generate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_generate_generate>
        }

        /**
         * Retrieves session data by session ID.
         */
        public async getSession(params: { sessionId: string }): Promise<ResponseType<typeof api_pptx_get_session_getSession>> {
            // Now make the actual call to the API
        ...
        public async listGeneratedFiles(params: RequestType<typeof api_pptx_list_generated_files_listGeneratedFiles>): Promise<ResponseType<typeof api_pptx_list_generated_files_listGeneratedFiles>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/generated-files`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_list_generated_files_listGeneratedFiles>
        }

        /**
         * Lists all sessions with summary information.
         */
        public async listSessions(): Promise<ResponseType<typeof api_pptx_list_sessions_listSessions>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_list_sessions_listSessions>
        }

        /**
         * Lists all available templates.
         */
        public async listTemplates(): Promise<ResponseType<typeof api_pptx_list_templates_listTemplates>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/templates`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_list_templates_listTemplates>
        }

        /**
         * Returns preview information for template and session data.
         */
        public async preview(params: RequestType<typeof api_pptx_preview_preview>): Promise<ResponseType<typeof api_pptx_preview_preview>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                sessionId:  params.sessionId,
         ...
         */
        public async updateSession(params: RequestType<typeof api_pptx_update_session_updateSession>): Promise<ResponseType<typeof api_pptx_update_session_updateSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/update-session`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_update_session_updateSession>
        }
         ...
         */
        public async uploadArchiveChunkRaw(options: PickMethods<"POST"> = {}): Promise<globalThis.Response> {
            options.method ||= "POST";
            return this.baseClient.callAPI(`/upload-archive/chunk-raw`, options)
        }

        /**
         * Raw endpoint for uploading archive files with unlimited body size
         */
        public async uploadArchiveRaw(options: PickMethods<"POST"> = {}): Promise<globalThis.Response> {
            options.method ||= "POST";
            return this.baseClient.callAPI(`/upload-archive-raw`, options)
        }

        /**
         * Uploads images either from archive or individual files and organizes them into folders.
         */
        public async uploadImages(params: RequestType<typeof api_pptx_upload_images_uploadImages>): Promise<ResponseType<typeof api_pptx_upload_images_uploadImages>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload-images`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_upload_images_uploadImages>
        }

        /**
         * Uploads a PowerPoint template file and extracts placeholder information.
         */
        public async uploadTemplate(params: RequestType<typeof api_pptx_upload_template_uploadTemplate>): Promise<ResponseType<typeof api_pptx_upload_template_uploadTemplate>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload-template`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_pptx_upload_template_uploadTemplate>
        }

        /**
         * Raw endpoint for uploading template files with unlimited body size
         */
        public async uploadTemplateRaw(options: PickMethods<"POST"> = {}): Promise<globalThis.Response> {
            options.method ||= "POST";
            return this.baseClient.callAPI(`/upload-template-raw`, options)
        }
    }
}
