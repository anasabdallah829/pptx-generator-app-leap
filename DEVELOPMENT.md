...
```bash
git remote add encore encore://pptx-generator-app-rb7i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/pptx-generator-app-rb7i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/pptx-generator-app-rb7i/settings/integrations/github)
